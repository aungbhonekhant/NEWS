                ...
                <div class="col-lg-12">
                    <h1 class="page-header">
                        ...
                        <a class="btn btn-social btn-bitbucket" href="{{route('post.index')}}">
                            ...
                            Edit Post <font size="5px"><b> => {{$post->title}}</b></font>
                        ...
                        <form role="form" action="{{route('post.update', $post->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                @foreach($menus as $menu)
                                      <option value="{{$menu->id}}" {{$menu->id == $post->menu_id? 'selected': ''}}>
                                        {{$menu->name}}
                                      </option>
                                @endforeach
                            ...
                            <div class="form-group">
                              <div class="input-group">
          												   ...
          												   <input id="thumbnail" class="form-control" type="text" name="img" value="{{ old('img', $post->img) }}">
					                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="user" value="{{Auth::user()->name}}" >     
